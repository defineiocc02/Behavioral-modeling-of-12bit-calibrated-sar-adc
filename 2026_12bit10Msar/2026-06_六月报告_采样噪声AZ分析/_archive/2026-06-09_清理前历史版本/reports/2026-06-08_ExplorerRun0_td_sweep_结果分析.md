...
> 数据源：VM 最新完成 run，`/home/meow/jxy/simulation/12bit_50M_SAR/test_12bit50MSAR_AMS_final/maestro/results/maestro/ExplorerRun.0`。本地归档见 `../raw_data/` 和 `../figures/`。
...
![summary_montage](../figures/summary_montage.png)
...
- `../raw_data/ExplorerRun.0.rdb`: ADE SQLite 结果数据库。
- `../raw_data/ExplorerRun.0.log`: ADE Explorer run 文本摘要。
- `../raw_data/maestro.sdb`: ADE session 数据。
- `../tables/td_sweep_metrics.csv`: 从 rdb 提取的逐 corner 指标。
- `../tables/td_sweep_aggregate.csv`: 从 rdb 提取的逐 design point 汇总。
